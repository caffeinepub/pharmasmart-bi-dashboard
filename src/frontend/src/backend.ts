...
export class Backend implements backendInterface {
    ...
    async getFrequentCustomers(arg0: bigint): Promise<Array<FrequentCustomer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFrequentCustomers(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHighValueCustomers(arg0: number): Promise<Array<HighValueCustomer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHighValueCustomers(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
